...
<body>
  ...
  <div class="dashboard-container">
    <div class="dashboard">
      <h2>Welcome, <%= session.getAttribute("customerName") != null ? session.getAttribute("customerName") : "User" %>!</h2>

      <a href="lendBook.jsp" class="card-btn">📖 Lend a Book</a>
      <a href="returnBook.jsp" class="card-btn">📚 Return a Book</a>
